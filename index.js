...
function animationControler(mainId, box1 , box2 , box3 , box4, bgimg){
    ...
    function cycleColors() {
        $('#container').removeClass("bg-[url('./assets/bgimgden.jpg')]");
        $('#container').addClass(`${bgimg}`);   
        $(`#${box1}`).addClass("box1");
        // $(`#${box3}`).addClass("box");
        $(`#${box2}`).addClass("box2");
    ...
    function defaulter(classname){
        ...
        $('#container').removeClass(`${bgimg}`);
        $("#container").addClass("bg-[url('./assets/bgimgden.jpg')]");
    }

}

animationControler("section-1", "box1", "box2", "box3", "box4", "fade-in-d");
animationControler("section-2", "sbox1", "sbox2", "sbox3", "sbox4", "fade-in-b");
animationControler("section-3", "tbox1", "tbox2", "tbox3", "tbox4", "fade-in-bu");
